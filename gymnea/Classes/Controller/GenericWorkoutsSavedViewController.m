...
- (void)reloadData
{
    ...
    if((self.needRefreshData) && (!self.loadingData)) {
        ...
        [gymneaWSClient requestSavedWorkoutsWithCompletionBlock:^(GymneaWSClientRequestStatus success, NSArray *workouts) {
...
- (void)searchWorkoutsWithFilters
{
    ...
    GymneaWSClient *gymneaWSClient = [GymneaWSClient sharedInstance];
    [gymneaWSClient requestLocalSavedWorkoutsWithType:workoutType
